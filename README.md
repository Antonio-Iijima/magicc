...
*magicc* is a system for simplified programming language development. As such, there are two primary ways to use it, and therefore two parallel guides. [Basic Usage](#basic-usage) is relevant to those interested in using languages generated by this system. [Advanced Usage](#advanced-usage) is for those interested in using magicc for language development and prototyping.
